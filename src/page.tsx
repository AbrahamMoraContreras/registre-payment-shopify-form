		...
		try {
			...
			if (response.ok) {
				setSubmitResult({
					success: true,
					message:
						"¡Comprobante enviado! Hemos recibido tu información de pago. Nuestro equipo la revisará próximamente.",
				});
			} else {
						...
						<Card sx={{ boxShadow: 3, height: "100%" }}>
							<CardContent sx={{ p: 3 }}>
								...
								<Stack spacing={1}>
									...
									>
										...
										<Typography variant="body2">
											${Number(info?.subtotal).toFixed(2)}
										</Typography>
									</Box>
									<Box
										sx={{
									...
									{info?.saldo_a_favor && info.saldo_a_favor > 0 ? (
										<Box
											sx={{
												display: "flex",
												justifyContent: "space-between",
										...
										>
											...
											<Typography
												...
												fontWeight="bold"
											>
												-${Number(info.saldo_a_favor).toFixed(2)}
											</Typography>
										</Box>
									) : null}
								</Stack>
											...
											<Stack spacing={1.5}>
												{info?.installment_number && (
													...
													>
														...
														<Chip
															label={`Pagando Cuota #${info.installment_number}`}
															color="primary"
															size="small"
														/>
													</Box>
												...
												>
													...
													>
														...
														{Math.max(
															0,
															Number(info.cuotas.valorCuota) -
																(info.saldo_a_favor || 0),
														).toFixed(2)}
													</Typography>
												</Box>
												{info.saldo_a_favor && info.saldo_a_favor > 0 ? (
													...
													>
														(Ya descontado su saldo a favor de $
														{Number(info.saldo_a_favor).toFixed(2)})
													</Typography>
												) : null}
											</Stack>
								...
								{!currentTipoTransaccion && (
									...
									>
										Selecciona un tipo de transacción a la derecha para ver los
										datos de pago.
									</Typography>
								)}
									...
									>
										...
										<Stack spacing={1}>
											...
											>
												...
												<Typography variant="caption" fontWeight="medium">
													{info?.cuentaDestino.telefono || "N/A"}
												</Typography>
											</Box>
										</Stack>
									</Box>
								...
								<Box sx={{ mt: 2 }}>
									<Typography variant="caption" color="text.secondary">
										Métodos aceptados:{" "}
										{info?.metodosAceptados?.join(", ") || "N/A"}
									</Typography>
								</Box>
							</CardContent>
						</Card>
								...
								{submitResult?.success ? (
									<Box sx={{ textAlign: "center", py: 4 }}>
										...
										<Typography color="text.secondary">
											Hemos recibido tu información de pago. Nuestro equipo la
											revisará próximamente.
										</Typography>
									</Box>
								) : (
									<Formik
												...
												<Grid container spacing={3}>
													...
													<Grid size={12}>
														<FormControl
															fullWidth
															error={
																touched.tipoTransaccion &&
																Boolean(errors.tipoTransaccion)
															}
														>
															<InputLabel id="tipo-transaccion-label">
																Tipo de Transacción
															</InputLabel>
															<Select
														...
														<>
															...
															<Grid size={12}>
																<TextField
																	...
																	onBlur={handleBlur}
																	error={
																		touched.numeroTelefonico &&
																		Boolean(errors.numeroTelefonico)
																	}
																	helperText={
																		touched.numeroTelefonico &&
																...
																>
																	<Box sx={{ flexGrow: 1 }}>
																		<TextField
																			...
																			onBlur={handleBlur}
																			error={
																				touched.monto && Boolean(errors.monto)
																			}
																	...
																	<Button
																		...
																		type="button"
																		onClick={() => {
																			const exact = info?.cuotas
																				? info.cuotas.valorCuota
																				: info?.total || 0;
																			const minusFavorable = Math.max(
																				0,
																				Number(exact) -
																					(info?.saldo_a_favor || 0),
																			);
														...
														<>
															...
															<Grid size={12}>
																<FormControl
																	...
																	error={touched.banco && Boolean(errors.banco)}
																>
																	<InputLabel id="banco-transfer-label">
																		Banco
																	</InputLabel>
																	<Select
															...
															<Grid size={{ xs: 12, sm: 4 }}>
																...
																>
																	<InputLabel id="tipo-documento-transfer-label">
																		Tipo Doc.
																	</InputLabel>
																	<Select
